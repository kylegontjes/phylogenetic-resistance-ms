...
#Packages
packages <- c("tidyverse","kableExtra","phylosuite")   
#Load Packages
...
TMP_SMX_lr_CI <- phyloaware_regression("TMP_SMX_dich_num",df = TMP_SMX_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
gentamicin_lr_CI <- phyloaware_regression("gentamicin_dich_num",gentamicin_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)   
AMK_lr_CI <- phyloaware_regression("AMK_dich_num",AMK_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
CST_lr_CI <- phyloaware_regression("CST_dich_num",CST_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
blbli_lr_CI <- phyloaware_regression("blbli_dich_num",blbli_regression_df,variables ="clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)  
```
...
## Modeling  Clade II
```{r,warning=F,message=F}
TMP_SMX_lr_CII <- phyloaware_regression("TMP_SMX_dich_num",df = TMP_SMX_regression_df,variables = "clade_II",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
gentamicin_lr_CII <- phyloaware_regression("gentamicin_dich_num",gentamicin_regression_df,variables = "clade_II",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)   
AMK_lr_CII <- phyloaware_regression("AMK_dich_num",AMK_regression_df,variables = "clade_II",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
CST_lr_CII <- phyloaware_regression("CST_dich_num",CST_regression_df,variables = "clade_II",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
blbli_lr_CII <- phyloaware_regression("blbli_dich_num",blbli_regression_df,variables ="clade_II",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)  
```
