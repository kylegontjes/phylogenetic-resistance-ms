...
lgd = Legend(labels = c("Demographics","Length of stay","Devices","Comorbidities","Antibiotic exposures"), legend_gp = gpar(fill = distinct_colors), title = "Variable type", 
    ncol = 1, title_position = "topcenter",labels_gp = gpar(fontsize = 10),title_gp = gpar(fontsize=12,fontface="bold"))

top_a_diverse = HeatmapAnnotation(
...
F4 <- UpSet(make_comb_mat(fake),right_annotation = NULL,top_annotation = top_a_diverse,comb_order = c(1:7), height = unit(4.5, "cm"))  
