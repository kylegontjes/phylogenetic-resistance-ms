...
# Add margin to this
figure <- cowplot::plot_grid(plotlist = heatmap_for_cowplot,labels="AUTO",ncol=2,label_x=-0.03,label_size = 16) + 
...
```{r}
ggsave("./figures/sfigure4.png",figure,width=11.5,height=9.2,dpi=900,bg='white')  
```
