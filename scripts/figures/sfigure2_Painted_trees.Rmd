...
sfigure2 <- cowplot::plot_grid(painted_trees_w_cluster_calls_wo_legends[[1]],painted_trees_w_cluster_calls_wo_legends[[2]],painted_trees_w_cluster_calls_wo_legends[[3]],painted_trees_w_cluster_calls_wo_legends[[4]],painted_trees_w_cluster_calls_wo_legends[[5]],legend_fig,ncol=3,labels =c("TMP-SMX","Gentamicin","Amikacin","Colistin","BL/BLI",""),label_x = 0,label_size = 12)
