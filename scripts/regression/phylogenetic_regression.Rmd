...
purposeful_output <- lapply(pheno,FUN=function(x){
  ...
  phyloaware_regression(phenotype,variables =eligible_variables,df=phenotype_df,first_present=T,patient_id="Patient_ID",culture_date="Cx_date",multivariable='purposeful',stepwise_direction = NULL,entry_criteria = 0.2,retention_criteria = 0.1,confounding_criteria = 0.2)
}) %>% `names<-`(pheno)
