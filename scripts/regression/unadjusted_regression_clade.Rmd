...
#Packages
packages <- c("tidyverse","devtools","kableExtra","cowplot","gridExtra",'forestplot','tableone','phylosuite','ape')   
#Load Packages
...
factor_vars_df <- df %>% select(clade_I) %>% as.data.frame()
...
TMP_SMX_lr <- phyloaware_regression("TMP_SMX_dich_num",df = TMP_SMX_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
gentamicin_lr <- phyloaware_regression("gentamicin_dich_num",gentamicin_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)   
AMK_lr <- phyloaware_regression("AMK_dich_num",AMK_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
CST_lr <- phyloaware_regression("CST_dich_num",CST_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)
blbli_lr <- phyloaware_regression("blbli_dich_num",blbli_regression_df,variables ="clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = F)  
```
...
feature_string <- c("","Non-Susceptible","Emergence","Spread","","Non-Susceptible","Emergence","Spread","","Non-Susceptible","Emergence","Spread","","Non-Susceptible","Emergence","Spread","","Non-Susceptible","Emergence","Spread")
...
forest_plot <- res_forest_plot(tabletext = tabletext,fp_rmetadata = fp_rmetadata,outcome_name="Clade I Isolate") 
forest_plot
```

# Save in regression data folder
```{r}
saveRDS(forest_plot,"./data/regression/unadjusted_regression_clade_figure.RDS")
```
