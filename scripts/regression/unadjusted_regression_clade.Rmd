...
TMP_SMX_lr <- phyloaware_regression("TMP_SMX_dich_num",df = TMP_SMX_regression_df,variables = "clade_I",first_present = T,patient_id = 'Patient_ID',culture_date = "Cx_date",multivariable = FALSE)
...
forest_plot <- res_forest_plot(tabletext = tabletext,fp_rmetadata = fp_rmetadata,outcome_name="ST258 Clade I",type_of_regression="Unadjusted") 
