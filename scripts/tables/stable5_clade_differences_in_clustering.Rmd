...
#Packages
packages <- c("tidyverse",'phylosuite','ape')   
#Load Packages
...
subset_analysis_to_clade <- function(phenotype,cladeI,clustering){
  clustering_CI <- asr_cluster_analysis(clustering %>% subset(child_name %in% cladeI),remove_faux = "yes") %>% mutate(clade = "Clade I")
  clustering_CII <- asr_cluster_analysis(clustering %>% subset(!child_name %in% cladeI),remove_faux = "yes") %>% mutate(clade = "Clade II")
