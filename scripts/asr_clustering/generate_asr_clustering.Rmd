...
for(i in pheno){
  ...
  asr_clustering <- asr_cluster_detection(df = df,tr = tr,tip_name_var = "isolate_no",patient_id="Patient_ID",pheno = pheno_dich, parent_child_df = parent_child,node_states = "joint",confidence = NULL,faux_clusters = "remove",remove_revertant = "yes",collapse_cluster = "yes")
  asr_clustering$asr_cluster_renamed_ns <-  reclassify_asr_resistance(asr_clustering$asr_cluster_renamed)
