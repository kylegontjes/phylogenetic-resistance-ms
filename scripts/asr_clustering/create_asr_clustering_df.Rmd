---
title: "create_asr_clustering_df"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
extract_dataset <- function(pheno){
  ...
  final_df <- obj %>% select("child_name","asr_cluster","asr_cluster_renamed","asr_cluster_renamed_ns","asr_cluster_collapsed") %>% `colnames<-`(c("isolate_no",paste0(pheno,"_",colnames(.[,2:5])))) %>% as.data.frame
  return(final_df)
}
