---
title: "Generate ancestral state reconstructions using phyloAMR"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
for(i in pheno){
  ...
  asr_model <- asr(df = df,tr = tr,tip_name_var = "isolate_no",pheno=pheno_dich,model = best_model,node_states = "joint", upper_bound=1e50, lower_bound=1e-9) 
